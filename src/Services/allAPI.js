...
// get video history called by view component
export const getVideoHistoryAPI = async ()=>{
   return await commonAPI("GET", `${SERVER_URL}/history`,"")
}

// remove history  called by history component        ---- pinne here json nnu manasilaavan id imp
...
// remove category  called by history component        ---- pinne here json nnu manasilaavan id imp
export const removeCategoryAPI = async (categoryId)=>{
   return await commonAPI("DELETE",`${SERVER_URL}/allCategory/${categoryId}`,{})
}

//get a video called by category compo
